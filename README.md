...
This is a custom-visualization and will appear in the custom visualization app on the NR1 homepage.  This is a radar diagram
...
You need to add a NRQL query containing facets, which will be used as axes
